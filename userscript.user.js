...
(async() => {
	...
	const i = "Type to highlight hints.",
		...
		p = async() => {
			...
			t = t.split("\n"), console.log("wordList is", t), (s = document.createElement("p")).innerHTML = '<span style="font-size: larger"><strong><a target="_blank" href="https://github.com/duggavo/assistente-skribbl" style="color:green">Assistente Skribbl</a> <span style="color:royalblue">di</span> <a target="_blank" href="https://github.com/duggavo" style="color:green">Duggavo</a></strong></span><br>', s.style = "position:fixed;bottom:0px;display:none;background:rgb(238,238,238);overflow-wrap:break-word;border-radius:2px;border: 4px solid rgb(238,238,238);width:90%;max-width:1300px;max-height:250px;overflow-y:auto;color:rgb(57,117,206);", a = document.createElement("span"), s.appendChild(a), document.getElementById("game-wrapper").appendChild(s), s.style.display = "block", n.setAttribute("placeholder", i), s.style.display = "", n.setAttribute("placeholder", i), n.onkeyup = d, setInterval(() => {
